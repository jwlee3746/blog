...
> 이 글은 실제 경험에서 얻은 판단을 공개 가능한 수준으로 일반화한 회고다. 다이어그램과 단계는 설명용이며 실제 제품 topology, 데이터 규모와 운영 수치를 나타내지 않는다.
...
이전: [3. 최신 evaluation harness의 공통 구조]({{site.url}}{{site.baseurl}}/Agent/agent-evaluation-harness-landscape/)
