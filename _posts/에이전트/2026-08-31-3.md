---
title: "[Agent Evaluation 2] 정답 누출 없는 multi-step replay"
...
[시리즈 허브]({{site.url}}{{site.baseurl}}/Agent/reproducible-agent-evaluation/) · 2/4
...
이전: [1. 평가 계약과 검증 경계]({{site.url}}{{site.baseurl}}/Agent/evaluation-contract-validation/)

다음: [3. 경로 채점과 discovery continuation]({{site.url}}{{site.baseurl}}/Agent/agent-path-scoring/)
