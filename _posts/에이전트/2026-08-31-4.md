---
title: "[Agent Evaluation 3] 경로 채점과 discovery continuation"
...
[시리즈 허브]({{site.url}}{{site.baseurl}}/Agent/reproducible-agent-evaluation/) · 3/4
...
이전: [2. 정답 누출 없는 multi-step replay]({{site.url}}{{site.baseurl}}/Agent/multi-step-agent-evaluation/)

다음: [4. 장시간 평가의 복구와 provenance]({{site.url}}{{site.baseurl}}/Agent/evaluation-checkpoint-provenance/)
