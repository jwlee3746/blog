---
title: "[Agent Evaluation 1] 평가 계약과 검증 경계"
...
> 이 글의 구조와 다이어그램은 일반화한 reference design이다. 실제 프로덕션 저장소, 서비스 구성이나 dataset 규모를 나타내지 않는다.

[시리즈 허브]({{site.url}}{{site.baseurl}}/Agent/reproducible-agent-evaluation/) · 1/4
...
3. 다음 step을 재현하는 데 필요한 검증된 tool output
...
- validation policy가 허용하는 threshold를 넘었다.
- 선택된 유효 case가 하나도 없다.
...
다음: [2. 정답 누출 없는 multi-step replay]({{site.url}}{{site.baseurl}}/Agent/multi-step-agent-evaluation/)
